...
$APPLICATION->SetTitle("ELECTRONICS");
?><div class="m-0">
<?$APPLICATION->IncludeComponent("bitrix:catalog", "electronics_catalog", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"IBLOCK_TYPE" => "ELECTRONICS",	// Тип инфоблока
		...
		"LIST_PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'2','BIG_DATA':false},{'VARIANT':'2','BIG_DATA':false},{'VARIANT':'2','BIG_DATA':false}]",	// Вариант отображения товаров
		...
		"SEARCH_PAGE_RESULT_COUNT" => "10",	// Количество результатов на странице
		...
		"SEF_FOLDER" => "/electronics/",	// Каталог ЧПУ (относительно корня сайта)
